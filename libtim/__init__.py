...
# encoding: utf-8
"""
This is Tim's library for useful stuff.

The docstrings provide concise runtime information. For more elaborate
documentation, consult the doxygen documentation.

Created by Tim van Werkhoven (werkhoven@strw.leidenuniv.nl) on 2012-04-03
